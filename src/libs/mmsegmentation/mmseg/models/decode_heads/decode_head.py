...
class BaseDecodeHead(BaseModule, metaclass=ABCMeta):
    ...
    def __init__(self,
        ...
        elif isinstance(loss_decode,object):
    ...
    def _stack_batch_gt(self, batch_data_samples: SampleList) -> Tensor:
        if self.loss_key == None:
            gt_semantic_segs = [
                data_sample for data_sample in batch_data_samples['gt_sem_seg']
            ]
        else:
            gt_semantic_segs = [
                data_sample for data_sample in batch_data_samples[self.loss_key]
            ]
